$(document).ready(function(){
  ...
  $("#myNavbarScroll a").on('click', function(event) {
 ...
 // Add smooth scrolling on all links inside the hamburger navbar
...
document.addEventListener('DOMContentLoaded', function(){ 
  ...
  const makeActive = (link) => menu_links[link].setAttribute("aria-current", "true");
  const removeActive = (link) => menu_links[link].setAttribute("aria-current", "false");
